...
<div class="navbar bg-base-100 shadow-md mb-4">
	...
	<div class="navbar-start">
		...
		<div class="tooltip tooltip-right" data-tip="Home Screen">
			<a href="/" class="btn btn-ghost btn-circle">
				<Icon icon="majesticons:home-line" style="font-size: 22px"></Icon>
			</a>
		</div>
	...
	<div class="navbar-center">
		<a href="/" class="btn btn-ghost text-xl">Probum</a>
	</div>

	<div class="navbar-end">

		<div class="tooltip tooltip-bottom" data-tip="Swap Theme">
			<label class="swap swap-rotate mr-2 pt-1">

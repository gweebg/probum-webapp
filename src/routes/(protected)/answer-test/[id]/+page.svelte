<!-- <script>
    ...
    // onMount(async () => {
    //   try {
    //     const response = await fetch(`endpoint/prova/${provaId}`, {
    //       headers: {
    ...
    onMount(async () => {
        try {
            ...
            const response = await fetch('$'); // Adjust the path based on your file structure
                ...
                "exam": {
                    ...
                    "questions": [
                        ...
                        },
                        {
                            ...
                            "answers": { "0": ["2", "3-1"], "1": ["inteira", "sem casas decimais"] }
                        }
                    ]
                }
            };
